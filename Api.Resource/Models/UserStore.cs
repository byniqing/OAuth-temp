...
namespace Api.Resource.Models
{
    public class UserStore
    {
            ...
            new User {
                ...
                Permissions=new List<UserPermission>
                {
                      new UserPermission
                      {
                          Id =1,
                          UserId = 1,
                          PermissionName = Permissions.UserCreate,
                          permissionAction=new List<PermissionAction>
                          {
                              new PermissionAction{Id=1, PermissionId=1,Url="api/Identity/OtherInfo"},
                              new PermissionAction{Id=2, PermissionId=1,Url="api/Identity/oidc1"}
                          }
                      },
                }
            },
        ...
        public bool CheckPermission(int userId, string url)
        {
            ...
            return user.Permissions.Any(_ => _.permissionAction.Any(_ => _.Url == url));
        }
    }
}
